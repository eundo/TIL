...
<figure className="project-showcase">
  ...
  <figcaption>실제 private 데이터 대신 작품 카드, 기억 단서, 검색 필터, 백업 흐름을 재구성한 공개용 화면 예시입니다.</figcaption>
</figure>
...
<div className="project-feature-grid">
  <section>
    <span>01</span>
    <h3>RIDI 링크 자동 채우기</h3>
    <p>링크를 넣으면 제목, 작가, 표지 같은 기본 정보를 먼저 채우고 실패하면 수동 입력으로 이어집니다.</p>
  </section>
  <section>
    <span>02</span>
    <h3>기억 단서 중심 기록</h3>
  ...
  <section>
    ...
    <p>브라우저 저장소를 기본으로 사용하고 JSON 내보내기와 가져오기로 개인 데이터를 직접 관리합니다.</p>
  </section>
</div>
...
<div className="project-flow">
  ...
  <div><span>2</span><strong>단서 기록</strong><p>인물, 관계성, 분위기, 스포 메모를 작품 카드에 쌓습니다.</p></div>
