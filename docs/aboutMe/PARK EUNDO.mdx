...
<div class="timeline">
    <div class="timeline-item">
        ...
        <div class="timeline-content">
            ...
            <ul>
                <li>
                    <strong>전분야 마이데이터 솔루션 구축 프로젝트 (진행중)</strong> 2024.01 - 2024.08
                </li>
                <li>
    ...
    <p><strong>역할:</strong> 공통업무 PL / 분석설계 및 개발</p>
        <ul>
            ...
            <li>
                ...
                <br /> 분석,설계 및 개발 진행
                <br />환경: Java 8, Gradle, Maven, Spring-boot, Postgresql, Git, Rest API, Angular, Typescript, HTML5
            </li>
        </ul>

        <p><strong>환경:</strong> Angular, Java 8, Gradle, Maven, Spring-boot, PostgreSQL</p>
    </div>
  </div>
