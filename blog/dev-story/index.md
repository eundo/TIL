...
역할, 구현 방식, 운영 리스크를 빠르게 확인할 수 있도록 사례 중심으로 묶었습니다.

<div className="case-proof-strip">
  <div>
    <strong>운영에서 나온 주제</strong>
    <span>배치, 비동기 API, 재처리처럼 실제 운영 질문으로 이어지는 내용을 다룹니다.</span>
  </div>
  <div>
    <strong>구현 판단 중심</strong>
    <span>기술 스택보다 왜 그렇게 처리했는지, 어떤 리스크를 줄였는지에 초점을 둡니다.</span>
  </div>
  <div>
    <strong>짧게 읽히는 구조</strong>
    <span>문제, 역할, 접근, 결과 순서로 필요한 정보만 확인할 수 있게 정리합니다.</span>
  </div>
</div>
